...
SECRET_KEY = 'django-insecure-5nfk@)rhs5$bre_bmnji^@g(eyse*lcwz5-gc$9m*vx8ba-=yf'
...
os.environ.setdefault("PGUSER", "jonathaniigelito")
os.environ.setdefault("PGPASSWORD", "Archduke29")
